    ...
    <div className="overflow-x-auto">
      <table className="w-full min-w-[640px]">
        ...
        <tbody className="divide-y divide-slate-100 dark:divide-slate-700/40">
          {rows.map((li, i) => (
            <tr key={i} className="hover:bg-slate-50 dark:hover:bg-white/3 dark:hover:bg-slate-700/20 transition-colors">
        ...
        {currentEstimate && (
          <div className="flex items-center gap-2 flex-wrap">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-slate-300 dark:border-white/12 dark:border-slate-600 bg-white dark:bg-slate-800 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/3 dark:hover:bg-slate-700 transition-colors"
            >
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                      selectedId === est.id
                        ...
                        : 'bg-white dark:bg-slate-800 border border-slate-300 dark:border-white/12 dark:border-slate-600 text-slate-600 dark:text-slate-300 hover:border-blue-400 dark:hover:border-blue-600'
                    }`}
                  >
          ...
          {currentEstimate && (
            <>
              ...
              <div className="flex items-center justify-center gap-4 py-4">
                <button
                  onClick={() => downloadCSV(currentEstimate)}
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-slate-300 dark:border-white/12 dark:border-slate-600 bg-white dark:bg-slate-800 text-sm font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/3 dark:hover:bg-slate-700 shadow-sm transition-colors"
                >
                  <Download className="w-4 h-4" />
                  Export Full CSV
                </button>
