...
const inputCls =
  'w-full rounded-lg border border-slate-300 dark:border-white/12 dark:border-slate-600 bg-white dark:bg-slate-800 ' +
        ...
        <div className="absolute top-full left-0 mt-1 z-30 w-36 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-xl overflow-hidden">
          {STATUS_OPTIONS.map((s) => (
            <button
              ...
              className={`w-full text-left px-3 py-2 text-xs hover:bg-slate-50 dark:hover:bg-white/3 dark:hover:bg-slate-700 transition-colors ${s === current ? 'font-bold text-blue-600 dark:text-blue-400' : 'text-slate-700 dark:text-slate-300'}`}
            >
              {s}
            </button>
          ))}
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3 items-center">
        <div className="relative flex-1 min-w-[180px]">
          ...
          <input
            className="w-full rounded-lg border border-slate-300 dark:border-white/12 dark:border-slate-600 bg-white dark:bg-slate-800 pl-9 pr-3 py-2 text-sm text-slate-800 dark:text-slate-100 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
        ...
        {/* Status filter */}
        <select
          className="rounded-lg border border-slate-300 dark:border-white/12 dark:border-slate-600 bg-white dark:bg-slate-800 px-3 py-2 text-sm text-slate-700 dark:text-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
          value={filterStatus}
